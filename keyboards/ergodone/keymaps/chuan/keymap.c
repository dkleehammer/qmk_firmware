 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |  ESC/~ |   1  |   2  |   3  |   4  |   5  | L1   |           | L1   |   6  |   7  |   8  |   9  |   0  |  BKSP  |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | Tab    |   Q  |   W  |   E  |   R  |   T  |  _   |           |  =   |   Y  |   U  |   I  |   O  |   P  |   \    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |`/Hyper |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |; / L2| Enter  |
 * |--------+------+------+------+------+------|[/HYPR|           |]/MEH |------+------+------+------+------+--------|
 * |(/LShift|Z/Ctrl|   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  |//Ctrl|)/RSHFT |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | CTRL |'"/L1| Alt  | Cmd  |Cmd  |                                  |'/Cmd |  -   |  =   |   [  |   ]  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | App  | Cmd  |       | L3   |Ctrl/Esc|
 *                                 ,------|------|------|       |------+--------+------.
 *                                 |      |      | Home |       | PgUp |        |      |
 *                                 | Space|  Cmd |------|       |------|  BKSP  |Space |
 *                                 |      |      | End  |       | PgDn |        |      |
 *                                 `--------------------'       `----------------------'
 */
...
[GAME] = LAYOUT_ergodox(
       ...
       LT(SYMB,KC_CAPSLOCK), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_H,
       KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_V,
                                           KC_TRNS, KC_TRNS,
                                                    KC_TRNS,
                                  KC_TRNS, KC_V, KC_TRNS,
    // right hand
